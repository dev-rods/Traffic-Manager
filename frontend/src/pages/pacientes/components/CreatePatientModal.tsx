...
export function CreatePatientModal({ open, onClose }: CreatePatientModalProps) {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (
        ...
        setServerError(response.data?.message ?? 'Erro ao criar paciente')
      } else {
        setServerError('Erro ao criar paciente')
      }
    }
  }
  ...
  return (
    <Modal open={open} onClose={handleClose} title="Cadastrar paciente">
